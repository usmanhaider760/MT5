namespace MT5TradingBot.UI
{
    public sealed partial class MainForm
    {
        ...
        private void ConfigureLogTabLayout()
        {
            ...
            layout.Controls.Add(CreateButtonRow("_logButtons", _btnLogDetails, _btnClearLog, _btnOpenLogFile, _btnOpenTradeLogFile, _btnSaveLog, _btnDeleteLogs), 0, 1);
        }
        ...
        private void ApplyVisualSystem()
        {
            ...
            StylePrimaryButton(_btnLogDetails, C_ACCENT);
            StylePrimaryButton(_btnOpenLogFile, C_ACCENT);
            StylePrimaryButton(_btnOpenTradeLogFile, C_ACCENT);
