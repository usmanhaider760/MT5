    ...
    public sealed partial class MainForm
    {
        ...
        private async Task RunBacktestAsync()
        {
            ...
            try
            {
                ...
                var result = await svc.RunAsync(trades, _cfg.Bot).ConfigureAwait(true);
        ...
        private void ShowBacktestStats(BacktestResult r)
        {
            ...
            _lblBtStats!.Text =
                ...
                (r.TotalCommissionUsd > 0 ? $"Comm: -{r.TotalCommissionUsd:F2} USD  |  " : "") +
                (r.TotalSlippageUsd > 0 ? $"Slip: -{r.TotalSlippageUsd:F2} USD  |  " : "") +
